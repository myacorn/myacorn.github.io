...
# myAcorn blog build configuration file, created by
# `ablog start` on Wed Sep 14 16:33:51 2016.
#
...
blog_authors = {
    'Ian Edwards, Helen Edwards': ('Ian Edwards, Helen Edwards', None),
}
...
htmlhelp_basename = 'myAcornblogdoc'
